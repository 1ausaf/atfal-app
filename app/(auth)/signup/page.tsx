  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-4 bg-transparent">
      <div className="w-full max-w-sm card-kid p-6">
        <h1 className="text-2xl font-bold text-center mb-2 text-gta-text">Create your account</h1>
        <p className="text-center text-gta-textSecondary text-sm mb-6">
        ...
        <p className="mt-4 text-center text-sm text-gta-textSecondary">
