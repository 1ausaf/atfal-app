...
export function AddNewsletterForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const res = await fetch("/api/activities/newsletter", {
        method: "POST",
    ...
    >
      ...
      <div>
        ...
        <div className="space-y-2">
          ...
          />
          <p className="text-xs text-slate-500">PNG only, max 2MB</p>
          <span className="text-slate-500 dark:text-slate-400 text-sm">or URL:</span>
          <input
            id="cover_url"
            type="url"
            value={coverUrl}
