...
export default async function SignOutPage() {
  ...
  return (
    <div className="max-w-md mx-auto p-6 text-center card-kid">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <Link
          ...
          className="px-5 py-2.5 rounded-xl bg-red-500 text-white hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700 transition-colors font-medium shadow-md"
        >
          Sign out
        </Link>
      </div>
