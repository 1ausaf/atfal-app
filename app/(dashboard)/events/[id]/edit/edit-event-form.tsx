...
export function EditEventForm({ event, majlisList, role, defaultMajlisId, majlisName }: EditEventFormProps) {
  ...
  const [majlisId, setMajlisId] = useState(event.majlis_id ?? defaultMajlisId ?? "");
